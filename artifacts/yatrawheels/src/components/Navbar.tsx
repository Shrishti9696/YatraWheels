...
export function Navbar() {
  ...
  const dashboardHref = isVendor ? "/vendor" : isDriver ? "/driver" : isAdmin ? "/admin" : "/dashboard";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group shrink-0" data-testid="link-logo">
            <div className="group-hover:scale-105 transition-transform duration-200 rounded-full overflow-hidden">
              <YatraWheelsLogoMark size={38} />
            </div>
                    ...
                    >
                      ...
                      <div className="py-1">
                        ...
                        <Link href={dashboardHref} onClick={() => setUserMenuOpen(false)}>
                          <span className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-colors cursor-pointer">
                            {(() => { const DIcon = dashboardIcon; return <DIcon className="w-4 h-4" />; })()}
                            {dashboardLabel}
                          </span>
                        </Link>
